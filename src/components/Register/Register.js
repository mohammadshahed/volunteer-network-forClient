...
const Register = () => {
    ...
    function subForm(e) {
        ...
        // adding user
        fetch('https://volunteer-network-bd.herokuapp.com/register', {
            method: 'POST',
        ...
        .then(data => {
            if(data){
                document.getElementById('register').innerHTML = '<h2 class="text-center text-success mt-5 pt-5">Registered Successfully</h2><h4 class="text-center">See your all registrations in the "My Registrations" page.</h4>'
            }
        })
    }
