...
const Home = () => {
    ...
    // load all events
    useEffect(() => {
        fetch('https://volunteer-network-bd.herokuapp.com/allEvents')
        .then(res => res.json())
    ...
    return (
        <main>
            ...
            <footer className="mt-3 py-3 text-center">
                <h5>Designed and Developed By : <a href="http://facebook.com/MohammadShaheduzzamanShahed">Mohammad Shaheduzzaman Shahed</a></h5>
            </footer>
        </main>
    );
};
