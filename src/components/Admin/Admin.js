...
const Admin = () => {
    ...
    // load all users
    useEffect(() => {
        fetch('https://volunteer-network-bd.herokuapp.com/allUsers')
        .then(res => res.json())
        .then(data => {
            setUsers(data);
            setReload(false);
    ...
    function removeUser(id) {
        fetch('https://volunteer-network-bd.herokuapp.com/remove/'+id, {
            method: 'DELETE'
        })
        .then(res => res.json())
    ...
    function addEvent(e) {
        ...
        fetch('https://volunteer-network-bd.herokuapp.com/addEvent', {
            method: 'POST',
        ...
        <section id="admin" className="container py-5 mt-5">
            ...
            <div className="row mt-5 ">
                <div className="col-md-4 mb-4 text-center">
                    ...
                    <form method="POST" onSubmit={addEvent} className="bg-light py-3 px-4 mt-3 border rounded">
                        ...
                        <input type="submit" value="Add Event" className="btn btn-warning rounded my-1" />
                    </form>
                    <h5 id="success" className="mt-4 text-success"> </h5>
                </div>
                <div className="col-md-8 text-center">
                    <h4 className="text-center my-4">All Volunteers</h4>
                    <table className="table table-sm table-bordered bg-light text-info">
                        <thead>
                            <tr>
                                <th>
                                    <img style={{imageColor:'red'}} src={userIcon} alt="" width="20px" />
                                </th>
