                ...
                <div className="collapse navbar-collapse text-center" id="nava">
                    <ul className="navbar-nav ml-auto">
                        <Link style={linkStyle} to="/my-registrations" className="shadow nav-item m-2 my-md-0">
                            <button className="nav-link btn btn-block btn-warning text-dark">My Registrations</button>
                        </Link>
                        <Link style={linkStyle} to="/admin" className="nav-item m-2 my-md-0">
                            <button className="nav-link btn btn-block btn-dark text-white">Admin</button>
                        </Link>
                        {
                            user.signed ?
                            <button onClick={signOutAll} className="nav-item btn btn-primary m-2  my-md-0 text-white">Sign out, {user.name}</button> :
                            <Link style={linkStyle} to="/login" className="nav-item m-2 my-md-0">
